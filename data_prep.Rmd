...
# # 
# # model.10x10CV <- train (team1win ~., data = train_nnet_scaled, subset=learn, method='nnet', maxit = 500, trace = FALSE,tuneGrid = expand.grid(.size=sizes,.decay=0), trControl=trc)
# 
# 
# ```
# 
